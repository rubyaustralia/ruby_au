...
RSpec.describe Election, type: :model do
  describe '#elected_users' do
    ...
    context 'when there are more nominees than vacancies' do
      ...
      before do
        create(:vote, nomination: amir, score: 3)
        create(:vote, nomination: amir, score: 1)

        create(:vote, nomination: billie, score: 2)
        create(:vote, nomination: billie, score: 8)
        create(:vote, nomination: billie, score: 2)

        create(:vote, nomination: carol, score: 4)
        create(:vote, nomination: carol, score: 10)

        create(:vote, nomination: denise, score: 9)
        create(:vote, nomination: denise, score: 1)
        create(:vote, nomination: denise, score: 8)
      end
