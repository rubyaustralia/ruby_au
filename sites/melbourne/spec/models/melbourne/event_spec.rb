...
RSpec.describe Melbourne::Event do
  ...
  describe "#name" do
    it "returns a humanized name from the slug" do
      event = described_class.new(slug: "2025-06-26-communicating-intent-in-code")
      expect(event.name).to eq("Communicating intent in code")
    end
  end
  ...
  describe "#schema" do
    it "returns the event schema" do # rubocop:disable RSpec/ExampleLength
      event = described_class.new(
        ...
        summary: "Make vs justfile vs mise and Rails 8 new with Michael Milewski and John Sherwood.",
      ...
      expect(event.schema).to \
        eq({
             ...
             "@type" => "Event",
             name: "Make vs justfile vs mise rails 8 new",
  ...
  describe "#open_graph_metadata" do
    it "returns the event open graph metadata" do
      ...
      expect(event.open_graph_metadata).to \
        eq({
             title: "2025-04-24 - Make vs justfile vs mise rails 8 new",
             description: "Make vs justfile vs mise and Rails 8 new with Michael Milewski and John Sherwood.",
